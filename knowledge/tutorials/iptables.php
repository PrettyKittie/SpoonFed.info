			...
			<div class="row">
					...
					<div class="layer">
						...
						<section>
							...
							<ol start="0">
								...
								<li><a href="#3">Connection States</a></li>
                ...
                <li><a href="#8">Additional Resources &amp; Recommended Reading</a></li>
						...
						<section>
							...
							<p>This write-up is intended to be a simple walkthrough for linux netfilter, and will be written more like a cheatsheet than a tutorial.  It'll cover a basic explanation of netfilter terminology, using basic iptables commands for configuring netfilter, some example rules, and a few additional capabilities. </p>
