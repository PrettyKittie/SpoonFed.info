<nav>
    <ul id="nav">
        ...
        <li class="has-sub"><a href="">Knowledge</a>
            <ul>
                <li><a href="/knowledge/hardware/hardware.php">Hardware</a></li>
                ...
                <li><a href="/knowledge/tools/tools.php">Shit Load of Tools</a></li>
				<li><a href="/knowledge/training/training.php">Training</a></li>
                <li><a href="/knowledge/tutorials/tutorials.php">Tutorials</a></li>
